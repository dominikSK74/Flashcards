...
QuizModel::QuizModel(QObject *parent) : QAbstractListModel(parent) {
...
void QuizModel::loadData(const QJsonDocument &data) {
    ...
    m_list.append(QuizObject("test", 10, "", QDateTime(), false));


    m_list.append(QuizObject("", 0, "", QDateTime(), true));
    endResetModel();
}
